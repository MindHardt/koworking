...
public static partial class AddVisit
{
        ...
        CancellationToken ct)
    {
        ...
        command.CommandText =
            ...
            INSERT INTO "site_visits" ("created_at", "location", "utm_campaign", "utm_content", "utm_medium", "utm_source", "utm_term")
            VALUES ({now:String}, {p0:String}, {p1:String}, {p2:Nullable(String)}, {p3:String}, {p4:String}, {p5:Nullable(String)});
            """;
